    ...
    override fun onCreateView(
        ...
        binding.updateContact.setOnClickListener {
            ...
            if (binding.updateNameEditText.text!!.isEmpty()) {
                ...
                Snackbar.make(binding.updateNameEditText, "Name is Mandatory.", Snackbar.LENGTH_SHORT).show();

            } else if (binding.updateNumberEditText.text!!.isEmpty()) {
                binding.updateNumberEditText.requestFocus()
                Snackbar.make(binding.updateNumberEditText, "Password is Mandatory.", Snackbar.LENGTH_SHORT).show();
            }
            else{
